...
public class chef_postDish extends AppCompatActivity {
    ...
    private boolean isValid() {
        ...
        if(TextUtils.isEmpty(descrption)){
            ...
            desc.setError("Mô tả là bắt buộc");
        }else{
            desc.setError(null);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if(mcropimageuri !=null && grantResults.length>0 && grantResults[0]== PackageManager.PERMISSION_GRANTED){
            ...
            Toast.makeText(this,"Đang hủy! Quyền không được cấp",Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE){
            ...
            if(resultCode==RESULT_OK){
                ...
                Toast.makeText(this,"Đã cắt thành công!",Toast.LENGTH_SHORT).show();
            }else if(resultCode == CropImage.CROP_IMAGE_ACTIVITY_RESULT_ERROR_CODE){
                Toast.makeText(this,"Không cắt được"+result.getError(),Toast.LENGTH_SHORT).show();
