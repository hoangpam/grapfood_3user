package com.example.grapfood.activity.image;
...
public class CircularImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs, com.blogspot.atifsoftwares.circularimageview.R.styleable.CircularImageView, defStyleAttr, 0);

        // Init Border
        if (attributes.getBoolean(com.blogspot.atifsoftwares.circularimageview.R.styleable.CircularImageView_c_border, true)) {
            float defaultBorderSize = DEFAULT_BORDER_WIDTH * getContext().getResources().getDisplayMetrics().density;
            setBorderWidth(attributes.getDimension(com.blogspot.atifsoftwares.circularimageview.R.styleable.CircularImageView_c_border_width, defaultBorderSize));
            setBorderColor(attributes.getColor(com.blogspot.atifsoftwares.circularimageview.R.styleable.CircularImageView_c_border_color, Color.WHITE));
        }

        setBackgroundColor(attributes.getColor(com.blogspot.atifsoftwares.circularimageview.R.styleable.CircularImageView_c_background_color, Color.WHITE));

        // Init Shadow
        if (attributes.getBoolean(com.blogspot.atifsoftwares.circularimageview.R.styleable.CircularImageView_c_shadow, false)) {
            shadowRadius = DEFAULT_SHADOW_RADIUS;
            drawShadow(attributes.getFloat(com.blogspot.atifsoftwares.circularimageview.R.styleable.CircularImageView_c_shadow_radius, shadowRadius),
                    attributes.getColor(com.blogspot.atifsoftwares.circularimageview.R.styleable.CircularImageView_c_shadow_color, shadowColor));
            int shadowGravityIntValue = attributes.getInteger(com.blogspot.atifsoftwares.circularimageview.R.styleable.CircularImageView_c_shadow_gravity, ShadowGravity.BOTTOM.getValue());
